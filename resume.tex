...
\cvlistdoubleitem{Programming Best Practices} {Computer Architecture}
\cvlistdoubleitem{Cloud Computing} {Operating Systems}
\cvlistdoubleitem{Analysis of Algorithms} {Human Computer Interaction}

\section{Experience}
\cventry{2010}{Student Project}{FSP Scheduler}{Ewing New Jersey}{\emph{C++}}
{In my Programming Best Practices class I created a scheduler used by my
  ...
  FSPs.}
\cventry{2010--2012}{Software Developer Intern}{BC Processing}{Vineland New Jersey}{\emph{Ruby on Rails}}
...
\cventry{Summer 2013}{Software Developer Intern}{Amazon.com}{Seattle Washington}{\emph{Java}}
...
\cvlistdoubleitem{Unix tools (Git, Vim, Tmux, Bash)} {Amazon Web Services}
\cvlistdoubleitem{Java, Groovy} {SQL}
